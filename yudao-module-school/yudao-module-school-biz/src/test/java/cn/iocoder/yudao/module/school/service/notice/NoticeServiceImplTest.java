package cn.iocoder.yudao.module.school.service.notice;
...
import cn.iocoder.yudao.module.school.controller.admin.notice.vo.*;
import cn.iocoder.yudao.module.school.dal.dataobject.notice.NoticeDO;
import cn.iocoder.yudao.module.school.dal.mysql.notice.NoticeMapper;
...
public class NoticeServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetNoticePage() {
       ...
       // 测试 type 不匹配
       noticeMapper.insert(cloneIgnoreId(dbNotice, o -> o.setType(null)));
       // 准备参数
